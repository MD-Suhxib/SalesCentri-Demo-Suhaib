...
const nextConfig: NextConfig = {
  ...
  experimental: {
    // Skip static generation for API routes that require env vars
    serverComponentsExternalPackages: ['@google/generative-ai', 'firebase-admin', 'openai', 'stripe'],
  },
  // Skip static page generation to avoid env var errors at build time
  output: 'standalone',
  images: {
    remotePatterns: [
      {
