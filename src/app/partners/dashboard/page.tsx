      ...
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <Link
            ...
            className="px-6 py-3 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:shadow-lg hover:shadow-blue-500/25 transition-all inline-flex items-center space-x-2"
          >
      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <Link
              href="/login-portal"
              className="inline-flex items-center space-x-2 text-gray-400 hover:text-blue-400 transition-colors mb-6"
            >
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    We'll notify you at <span className="text-blue-400 font-medium">{application.partnerDetails.contactPersonEmail}</span> once the review is complete.
                  </p>
                </div>
              </div>
            </motion.div>
                    ...
                    {Object.entries(application.documents).map(([docId, doc]) => (
                      ...
                      >
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-all flex items-center space-x-2"
                        >
              ...
              >
                ...
                <div className="space-y-6">
                  <div className="relative pl-6 border-l-2 border-blue-500">
                    ...
                    <div>
                      <p className="text-sm font-medium text-blue-400">Submitted</p>
                  ...
                  <div className={`relative pl-6 border-l-2 ${application.status === 'under-review' || application.status === 'approved' || application.status === 'rejected' ? 'border-blue-500' : 'border-gray-700'}`}>
                    <div className={`absolute -left-[9px] top-0 w-4 h-4 rounded-full ${application.status === 'under-review' || application.status === 'approved' || application.status === 'rejected' ? 'bg-blue-500' : 'bg-gray-700'}`}></div>
                    <div>
                      <p className={`text-sm font-medium ${application.status === 'under-review' || application.status === 'approved' || application.status === 'rejected' ? 'text-blue-400' : 'text-gray-400'}`}>
                        Under Review
                      </p>
                      <p className="text-xs text-gray-400 mt-1">
                  ...
                  <div className={`relative pl-6 border-l-2 ${application.status === 'approved' || application.status === 'rejected' ? 'border-blue-500' : 'border-gray-700'}`}>
                    <div className={`absolute -left-[9px] top-0 w-4 h-4 rounded-full ${application.status === 'approved' ? 'bg-blue-500' : application.status === 'rejected' ? 'bg-red-500' : 'bg-gray-700'}`}></div>
                    <div>
                      <p className={`text-sm font-medium ${application.status === 'approved' ? 'text-blue-400' : application.status === 'rejected' ? 'text-red-400' : 'text-gray-400'}`}>
