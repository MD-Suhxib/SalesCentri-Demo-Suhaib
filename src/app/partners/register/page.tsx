...
export default function PartnerRegisterPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (result.success) {
        router.push(`/partners/dashboard?applicationId=${result.applicationId}`);
      } else {
    ...
    <div id="auth" className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 md:p-8 mb-8 scroll-mt-24">
      ...
      {authChecked && isAuthenticated ? (
        <div className="space-y-4">
          ...
          <button
            className="px-6 py-3 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:shadow-lg hover:shadow-blue-500/25 transition-all flex items-center space-x-2"
        ...
        <div>
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full px-6 py-3 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:shadow-lg hover:shadow-blue-500/25 transition-all flex items-center justify-center space-x-2"
            >
              {authTab === 'signin' ? (
                <>
      ...
      <div id="partnership-type" className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 md:p-8 mb-8 scroll-mt-24">
        <div className="flex items-center gap-3 mb-6">
          <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${
            registrationData.partnershipType ? 'bg-blue-500 text-white' : 'bg-blue-600 text-white'
          }`}>
  ...
  const CountrySection = () => {
    ...
    return (
      <div id="country" className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 md:p-8 mb-8 scroll-mt-24">
        <div className="flex items-center gap-3 mb-6">
          <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${
            registrationData.country ? 'bg-blue-500 text-white' : 'bg-blue-600 text-white'
          }`}>
  ...
  const DetailsSection = () => {
    ...
    return (
      <div id="details" className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 md:p-8 mb-8 scroll-mt-24">
        <div className="flex items-center gap-3 mb-6">
          <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${
            isFormValid() ? 'bg-blue-500 text-white' : 'bg-blue-600 text-white'
          }`}>
        ...
        <div className="space-y-4">
          {fields.companyLegalName && (
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all"
          ...
          <button
            ...
            className="mt-4 px-6 py-3 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:shadow-lg hover:shadow-blue-500/25 transition-all flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
  ...
  const DocumentsSection = () => {
    ...
    return (
      <div id="documents" className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 md:p-8 mb-8 scroll-mt-24">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center text-sm font-bold">5</div>
                ...
                <div className="ml-4">
                  {registrationData.documents?.[doc.id] ? (
                    ...
                    <label className="cursor-pointer">
                      ...
                      />
                      <div className="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-all flex items-center space-x-2">
        ...
        <button
          ...
          className="mt-6 px-6 py-3 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:shadow-lg hover:shadow-blue-500/25 transition-all flex items-center space-x-2"
        >
  ...
  const ReviewSection = () => {
    ...
    return (
      <div id="review" className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 md:p-8 mb-8 scroll-mt-24">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center text-sm font-bold">6</div>
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            disabled={submitting}
            className="w-full px-6 py-4 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:shadow-lg hover:shadow-blue-500/25 transition-all flex items-center justify-center space-x-2 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {submitting ? (
              <>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          {showDraftBanner && (
            <motion.div
              ...
              className="mb-6 bg-gradient-to-r from-blue-600/20 to-blue-400/20 border border-blue-500/30 rounded-xl p-4"
            >
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        {step.completed && <CheckCircle className="w-4 h-4 text-blue-400" />}
