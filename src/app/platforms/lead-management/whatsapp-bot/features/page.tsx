...
import { MessageSquare, Bot, ArrowRight, CheckCircle, Star, Zap, Shield, Clock, Users, Smartphone, Globe, Settings, BarChart3 } from 'lucide-react';

export default function WhatsAppBotFeaturesPage() {
  ...
  const features = [
    {
      ...
      capabilities: [
        "GPT-powered conversation engine",
    ...
    },
    {
      ...
      capabilities: [
        ...
        "Rich media message support (images, videos, documents)",
        "Interactive buttons &amp; quick replies",
        "List messages &amp; product catalogs",
    ...
    },
    {
      ...
      description: "Comprehensive customer profile and interaction tracking",
      capabilities: [
    ...
    },
    {
      ...
      capabilities: [
        "Custom conversation flows &amp; decision trees",
        ...
        >
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive WhatsApp automation capabilities designed to transform customer interactions 
              and streamline business communications.
            </p>
          </div>
        </motion.section>
        ...
        >
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Why Choose Our WhatsApp Bot?</h2>
              <p className="text-lg text-gray-300">
                Advanced features that set us apart from traditional WhatsApp automation tools
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Sub-second response times for instant customer satisfaction"
                },
                {
                  icon: Globe,
                  title: "Global Scale",
                  description: "Handle millions of conversations across multiple time zones"
                },
                {
                  icon: Star,
                  title: "Easy Setup",
                  description: "Deploy in minutes with our intuitive drag-and-drop builder"
                },
                {
                  icon: Clock,
        ...
        >
          <div className="max-w-4xl mx-auto text-center px-6">
            ...
            <p className="text-lg text-gray-300 mb-8">
              See how our advanced WhatsApp Bot features can transform your customer communications and business operations.
            </p>
