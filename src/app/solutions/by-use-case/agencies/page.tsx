        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
              ...
              <span className="bg-gradient-to-r from-purple-400 to-blue-500 bg-clip-text text-transparent"> White-Label AI Automation</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8">
              Transform your agency into a sales automation powerhouse with our comprehensive white-label platform. Offer enterprise-grade AI sales tools under your brand, earn up to 30% recurring commissions, and build predictable revenue streams. From lead generation to deal closure, provide your clients with cutting-edge automation while establishing your agency as the go-to sales technology partner.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/get-started/contact?type=partnership" className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:shadow-2xl hover:shadow-purple-500/30 transition-all duration-300 flex items-center gap-2 justify-center hover:scale-105 cursor-pointer">
                Apply for Partnership
                <ArrowRight className="w-5 h-5" />
              </Link>
              <Link href="/get-started/book-demo?type=partnership" className="border border-purple-500/30 text-purple-300 px-8 py-4 rounded-xl font-semibold hover:bg-purple-500/10 transition-all duration-300 cursor-pointer">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-white mb-4">Common Agency Challenges We Solve</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Transform typical agency pain points into competitive advantages with our comprehensive solution.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-red-500/10 to-orange-600/10 border border-red-500/20 rounded-xl p-8"
            >
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-300">
                  ...
                  <span>Difficulty scaling service delivery without massive overhead</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Limited technical expertise to build custom solutions</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Unpredictable project-based revenue streams</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <span>High client acquisition costs and retention challenges</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Competing against larger agencies with bigger budgets</span>
                </li>
              </ul>
            </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-green-500/10 to-emerald-600/10 border border-green-500/20 rounded-xl p-8"
            >
              <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-300">
                  ...
                  <span>Scalable white-label platform that grows with your agency</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Enterprise-grade technology without development costs</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Predictable recurring revenue with 30% commission rates</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>High-value offering that justifies premium pricing</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Competitive differentiation through cutting-edge AI technology</span>
                </li>
              </ul>
            </motion.div>
          </div>
